  ...
  return (
    <>
      <div className='flex flex-col items-center justify-center h-full min-h-screen p-8 mb-10 lg:p-0 md:mb-8 lg:mb-0 ' style={{ fontFamily: "Montserrat, sans-serif" }}>
        <motion.div
          className='w-full max-w-xl p-5 py-9 mt-12 shadow-xl dark:shadow-lg lg:max-w-[640px] lg:p-10 lg:pb-7 lg:pt-10 bg-gradient-to-l from-slate-100 to-slate-300 dark:from-neutral-800 dark:to-neutral-900 rounded-3xl'
        ...
        >
          ...
          <div className='mt-10'>
            <p className="text-[12px] text-center text-transparent bg-clip-text bg-gradient-to-r from-red-600 via-teal-400   to-purple-500 md:text-[14px] lg:text-[16px]  dark:from-red-600 dark:via-teal-400  dark:to-purple-500 font-extralight">
